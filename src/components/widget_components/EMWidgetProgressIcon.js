...
//component - CoreUI / EMWidgetProgressIcon
const EMWidgetProgressIcon = (props) => {
  const {
    children,
    className,
    //
...
EMWidgetProgressIcon.propTypes = {
...
EMWidgetProgressIcon.defaultProps = {
  value: 25,
};

export default EMWidgetProgressIcon;
