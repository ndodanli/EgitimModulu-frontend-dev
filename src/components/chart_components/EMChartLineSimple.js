...
import { getColor, deepObjectsMerge } from "../utils/index";
import { EMChartLine } from "./EMChart";

const EMChartLineSimple = (props) => {
  const {
    borderColor,
    backgroundColor,
...
EMChartLineSimple.defaultProps = {
...
export default EMChartLineSimple;
