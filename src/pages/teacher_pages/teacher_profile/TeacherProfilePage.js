...
import { putTeacherProfile } from "../../../actions/shared/userActions/profileActions";
      ...
      .then((result) => {
        if (result.isConfirmed) {
          ...
          if (updatedProps) {
            ...
            dispatch(putTeacherProfile(updatedProps, userInfo.id));
      ...
      <div className="form-row">
        <div className="col">
          ...
          <EMInputGroup className="mb-1">
            ...
            {error &&
              error.FirstName &&
              error.FirstName.map((errMessage) => (
